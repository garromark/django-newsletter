...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('newsletter_subscription', (
            ...
            ('activation_code', self.gf('django.db.models.fields.CharField')(default='7a8f2360249ccee891affaf0f5b9a40a70bb27ca', max_length=40)),
        ...
        db.create_table('newsletter_submission', (
            ...
            ('publish_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 17, 0, 0), null=True, db_index=True, blank=True)),
    ...
    models = {
        ...
        'newsletter.emailtemplate': {
            'Meta': {'unique_together': "(('title', 'action'),)", 'object_name': 'EmailTemplate'},
        ...
        'newsletter.newsletter': {
            ...
            'site': ('django.db.models.fields.related.ManyToManyField', [], {'default': '[1L]', 'to': "orm['sites.Site']", 'symmetrical': 'False'}),
        ...
        'newsletter.submission': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 17, 0, 0)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'newsletter.subscription': {
            ...
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'1cb8f8ce0fd438c60cfa54561bd8c3d43ffb89ef'", 'max_length': '40'}),
